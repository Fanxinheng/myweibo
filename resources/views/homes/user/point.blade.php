                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-12" style="width: 830px;background-color: #fff;margin-left: -2px;margin-top: 10px;padding-bottom: 10px">
                                ...
                                <div class="col-log-2" style="float: left;margin-top: 10px;margin-right: 10px">
                                    <img src="http://ozsrs9z8f.bkt.clouddn.com/{{$v->user_info->photo}}?imageView2/1/w/30/h/30/q/75"
                                    id="img" class="img-circle">
                                </div>
                                <!-- 名称和时间 -->
                                <div class="col-log-8" style="margin-top:12px;">
                                    <b>
                                        <a href="/home/other/user/{{$v->user_info->uid}}">
                            ...
                            <!-- <div style="padding:20px 350px;border-top-color:#000;margin-bottom:
                            -20px; line-height:40px;"><span>回复</span></div> -->
                            @endforeach
                        </div>
                        @endif
                        <!-- 微博遍历结束 -->
