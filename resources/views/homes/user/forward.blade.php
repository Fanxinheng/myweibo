            ...
            <nav class="navbar navbar-fixed-top" id="navbar">
                <div class="container">
                    <div class="navbar-header" id="navbar-header1">
                        <a href="/home/login">
                            <img src="http://ozsrs9z8f.bkt.clouddn.com/{{$config[0]->logo}}" alt=""
                            style="width:80px;height:27px;margin-top:7px;">
                        </a>
                    </div>
                    ...
                    <div class="jumbotron" id="backg" style="background:url('/homes/images/2016.jpg');background-repeat:no-repeat">
                        ...
                        <div class="col-md-4">
                            ...
                            <div id="jimg" style="margin-left: 100px">
                                <img src="http://ozsrs9z8f.bkt.clouddn.com/{{$rev->photo}}?imageView2/1/w/100/h/100/q/75"
                                style="width:100px;" id="img" class="img-circle">
                            </div>
                            <div>
                                <!-- 昵称 -->
                                ...
                                <div id="nickName" style="margin-top:10px;font-size: 15px;">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年龄:&nbsp;{{$rev->age}}&nbsp;&nbsp;职业:&nbsp;{{$rev->work}}&nbsp;&nbsp;积分:
                                    <span id="fsoc">
                                        {{$rev->socre}}
                                    </span>
                                    &nbsp;&nbsp;&nbsp;性别:&nbsp; @if($rev->sex=='w') 女 @else 男 @endif
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <ul class="nav nav-sidebar">
                            ...
                            <li>
                                <a href="/home/replay">
                                    ...
                                    @else
                                    <div style="width: 20px;height: 20px;background:#fa7d3c;float: right;border-radius: 10px;margin-left: 3px;text-align:center;color: #fff;line-height: 20px;display: none"
                                    id="rediv">
                                    </div>
                                    @endif
                                </a>
                        ...
                        <div class="col-lg-12" id="tiezi" style="width: 830px">
                            <div class="col-lg-12">
                                ...
                                <div class="col-log-2" id="tieimg">
                                    <img src="http://ozsrs9z8f.bkt.clouddn.com/{{$v->user_info->photo}}?imageView2/1/w/50/h/50/q/75"
                                    id="img" class="img-circle">
                                </div>
                                <!-- 名称和时间 -->
                                <div class="col-log-8" id="tiename" style="margin-top: 20px">
                                    <b>
                                        <a href="/home/other/user/{{$v->user_info->uid}}" style="text-decoration:none;">
                            ...
                            <div class="col-lg-10" style="margin-left: 70px;margin-top: 10px">
                                <a href="/home/blog/forward/{{$v->tid}}" style="text-decoration:none;">
                                    {{$v->fcontent}}
                                </a>
                            </div>
                            ...
                            <div class="col-lg-10" style="background-color: #F2F2F5;padding:5px;margin-left: 83px;margin-top: 5px;margin-bottom: 10px;border-radius: 10px;line-height: 20px">
                                ...
                                <a href="/home/blog/forward/{{$re->cid}}" style="text-decoration:none;">
                                    {{$re->content}}
                                </a>
                                @if($re->image)
                                <div style="margin-top: 10px" id="fimg">
                                    ...
                                    ?>
                                     @foreach($imgs as $i)
                                        <img src="http://ozsrs9z8f.bkt.clouddn.com/{{$i}}?imageView2/0/q/75|watermark/2/text/TVlXRUlCTy5DT00=/font/5a6L5L2T/fontsize/400/fill/I0YxRUZFNg==/dissolve/100/gravity/SouthEast/dx/10/dy/10|imageslim"
                                        style="width:110px;" id="img">
                                        @endforeach
                                </div>
                                @else
                                <div>
