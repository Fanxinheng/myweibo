            ...
            <div class="WB_miniblog">
                <div class="WB_miniblog_fb">
                        ...
                        <div class="WB_global_nav WB_global_nav_v2 " node-type="top_all">
                            <div class="gn_header clearfix" style="width:1200px">
                                ...
                                <div class=" gn_search_v2">
                                    ...
                                    name="15102240605332" type="text" style="height:25px" placeholder="搜索你想要的">
                                    ...
                                    <!--搜索热词下拉-->
                                    <!-- <div class="gn_topmenulist_search" node-type="searchSuggest" style="display:
                                    none;">
                    ...
                    <div class="WB_main clearfix" id="plc_frame">
                        ...
                        <!-- 广告显示页面 -->
                    <div style="height:480px;width:340px; float:right; overflow:hidden;">
                         <!-- 公告专用 -->
                        <div class="UG_box_l" style="width:340px;height:220px;">
                            <div class="UG_contents">
                                    <h1 class="UG_box_title">
                                            公告专用
                                    </h1>
                                    <div class="UG_tag_list">
                                    ...
                                    <div class="UG_contents">
                                        <div class="UG_tag_list">
                                            <li>
                                                ...
                                                href="http:\\{{($v->link)}}">
                                                    <i class="item_icon">
                                                       <img src="{{$v->pic}}" alt="" style="width:280px;height:200px" ;/>
                                                    </i>
                                                </a>
            ...
            <div class="WB_footer S_bg2">
                ...
                <div class="other_link S_bg1 clearfix T_add_ser">
                    <p class="copy_v2">
                        @foreach($rec as $k=>$v)
                            @if($v->status==0)
                                <a href="http:\\{{$v->link}}" target="_blank" class="S_txt2">{{$v->user}}</a>
                            @endif
                        @endforeach
                    </p>
                    <p class="copy_v2">
