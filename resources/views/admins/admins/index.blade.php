...
<div class="mws-panel-body no-padding">
    ...
    <tbody role="alert" aria-live="polite" aria-relevant="all" style="text-align: center;">
        ...
        <tr class="@if($k%2 == 0) odd @else even @endif">
            ...
            <td class=" ">{{$v->phone}}</td>
            <td class=" ">
                <img src="{{$v->pic}}" alt="" style="width:50px;height:50px"/></td>
            <td>
                <a href="/admin/admins/{{$v->id}}/edit">
                    <button class="btn btn-default" role="button">修改</button>
                </a>
    ...
    <div class="dataTables_paginate paging_full_numbers" id="DataTables_Table_1_paginate">
        <style type="text/css">
            .pagination li{
                ...
                box-shadow: 0 1px 0 rgba(0, 0, 0, 0.5), 0 1px 0 
            ...
            .pagination .active{
                ...
                color: #323232; background-color: #c5d52b; 
            }
            .ul{margin:0px;
                }
        </style>
