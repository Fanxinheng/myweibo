...
<body>
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/admins/admin/admins/create">管理员添加</a></li>
                            <li><a href="/admins/admin/admins">管理员列表</a></li>
                            <li><a href="/admins/admin/users">用户列表</a></li>
                        </ul>
    ...
    <![endif]-->
    <script src="/admins/plugins/flot/plugins/jquery.flot.min.js"></script>
